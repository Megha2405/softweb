...
<body>
    ...
    <footer>
        Designed with <i class="fa-regular fa-heart"></i> by Megha S &copy;
    </footer>
</body>
...
footer {
    text-align: center;
    margin-top: 10%;
    background-color: rgba(208, 167, 199, 0.5);
    color: black;
    font-family: "Nunito", sans-serif;
    font-size: 28px;
}
